...
if (localStorage.length != 7) {
	localStorage.clear();
	localStorage.teamMode = false;
	localStorage.team = 687;
...
if (JSON.parse(localStorage.clockMode)) {
	...
	if (JSON.parse(localStorage.teamMode))	{
		teamNum = JSON.parse(localStorage.team);
...
function switchToClockMode()	{
	localStorage.teamMode = false;
	localStorage.clockMode = true;
}

function switchToTeamMode(teamNumber)	{
	localStorage.teamMode = true;
	localStorage.team = teamNumber;
	localStorage.clockMode = false;
}

function switchTeam(teamNumber)	{
	switchToTeamMode(teamNumber)
}
